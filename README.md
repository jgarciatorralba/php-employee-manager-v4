...
employeeManager.php // In this file we left you a list of named methods to implement and use.
...
This is also a command in Unix systems. We are going to give you an overview in order to familiarise with it and then use it in the application for the extra feature.
